...
class Solution {
    func reverse(_ x: Int) -> Int {
        ...
        let firstYu = arr[1]
        let arr1 = calculcate(x: firstYu as! Int)
        let secondDigit: Int = arr1[0] as! Int
        let secondYu: Int = arr1[1] as! Int
        ...
        if ifLastDigitShang != -1 {
            ...
            result = thirdDigit * 100 + secondDigit * 10 + firstDigit * 1
        }
    ...
    func calculcate(x: Int) -> Array<Any> {
        ...
        return [firstDigit, firstYu] //[第一位，余数]
    }
    
}

let sol = Solution()
let x = sol.reverse(45);
